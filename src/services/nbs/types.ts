...
export type NbsConfig = {
  ...
  seeding?: {
    ...
    staticData?: {
      indicatorGroups?: Array<{ id: number | string; name: string }>;
      adminAreas?: Array<{ id: number | string; name: string; code: string }>;
...
export type NbsRunRange = { startDate?: string; endDate?: string; source?: string };
...
export type CollectionInfo = { name: string; idField: string };
